...
for t in test_rules.py test_reverse.py test_reconcile.py test_touch_adds.py test_short.py test_review_fixes.py test_accounts.py test_app_accounts.py; do
