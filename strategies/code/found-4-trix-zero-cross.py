"""
TRIX zero cross  --  found by the research pass on 2026-09-02

A triple-smoothed rate of change crossing zero. Very slow and very quiet -- the opposite failure mode to the fast families.

WHAT THE BACKTEST SAID (out of sample, on data never used to choose anything)
    score (P/L per $ drawdown, median symbol)   +0.232
    in-sample score, for comparison             +0.500
    decay out of sample                         0.46
    profitable on                               6 of 8 symbols
    trades                                      998
    summed P/L at 100 shares                    +$9,361.87
    control (random entry) had to be beaten at  -0.226
    beats that control                          yes
    at 2x the assumed slippage             +0.095
