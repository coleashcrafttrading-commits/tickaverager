"""
VWAP z-score reversion  --  found by the research pass on 2026-09-02

Fade a stretch of N session sigmas from VWAP. The single most cited intraday reversion rule, and the one most often tested without a session reset -- which turns VWAP into a slow moving average and the result into fiction.

WHAT THE BACKTEST SAID (out of sample, on data never used to choose anything)
    score (P/L per $ drawdown, median symbol)   +0.628
    in-sample score, for comparison             +1.073
    decay out of sample                         0.58
    profitable on                               6 of 8 symbols
    trades                                      653
    summed P/L at 100 shares                    +$1,469.08
    control (random entry) had to be beaten at  +0.009
    beats that control                          yes
    at 2x the assumed slippage             +0.322
